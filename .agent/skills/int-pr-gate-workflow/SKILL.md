...
## 2. Reviewer Decisions & Rejection Handling

When a PR Review is marked as **`Rejected`** or **`Changes Requested`**:
- **Gate 0 Rejection**: Author must update `.ai-context/BRD.md` to resolve comments and re-submit for Gate 0 PR review.
...
## 3. 5-Artifact Synchronization Protocol
...
3. Governing Spec (`.ai-context/specs/<slug>.spec.md`)
