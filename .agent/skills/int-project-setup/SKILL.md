...
```powershell
# 1. Bulk Copy Control Plane Rules & Workflows
...
# 2. Bulk Copy Knowledge Base Engineering Templates
Copy-Item -Recurse -Force "C:\Users\Supratim_Jetty\.gemini\config\templates\*" ".ai-context\templates\"

# 3. Bulk Copy Local Project Skills (STRICT RULE: Copy ONLY skill directory and SKILL.md file)
